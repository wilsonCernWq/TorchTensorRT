...
new_local_repository(
   name = "libtorch",
   path = "C:/Users/wilso/Documents/Softwares/win/libtorch-win-shared-with-deps-1.11.0+cu113/libtorch-Release",
   build_file = "third_party/libtorch/BUILD"
)
...
new_local_repository(
   name = "cudnn",
   path = "C:/Users/wilso/Documents/Softwares/win/cudnn-windows-x86_64-8.4.0.27_cuda11.6-archive",
   build_file = "@//third_party/cudnn/local:BUILD"
)

new_local_repository(
  name = "tensorrt",
  path = "C:/Users/wilso/Documents/Softwares/win/TensorRT-8.2.3.0.Windows10.x86_64.cuda-11.4.cudnn8.2/TensorRT-8.2.3.0",
